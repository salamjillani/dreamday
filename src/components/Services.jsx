  ...
  return (
    <div className="mb-16">
      <div className="text-center mb-8">
        <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 font-serif">{title}</h3>
      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="relative overflow-hidden rounded-2xl shadow-2xl">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-[#1d395e]/70 hover:bg-[#1d395e]/90 text-white p-2 rounded-full transition-all duration-200 hover:scale-110"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-[#1d395e]/70 hover:bg-[#1d395e]/90 text-white p-2 rounded-full transition-all duration-200 hover:scale-110"
          >
...
const Services = () => {
  ...
  return (
    <section 
      id="services" 
      className="bg-[#1d395e] text-white py-20 px-4 relative"
      style={{
